...
export default function Process() {
  return (
    <section id="proceso" className="w-full py-24 bg-[#0A1A3A] text-white px-6 /30">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Paso 1 */}
          <div className="p-8 bg-[#102544] rounded-xl border border-[#C9A86A] shadow-lg hover:shadow-xl transition">
            <Search className="mx-auto text-[#C9A86A]" size={48} />
            <div className="text-5xl font-bold text-[#C9A86A] mt-4">1</div>
            <h3 className="mt-4 text-2xl font-semibold text-[#C9A86A]">
              Diagnóstico
            </h3>
          ...
          {/* Paso 2 */}
          <div className="p-8 bg-[#102544] rounded-xl border border-[#C9A86A] shadow-lg hover:shadow-xl transition">
            <ClipboardCheck className="mx-auto text-[#C9A86A]" size={48} />
            <div className="text-5xl font-bold text-[#C9A86A] mt-4">2</div>
            <h3 className="mt-4 text-2xl font-semibold text-[#C9A86A]">
              Evaluación
            </h3>
            <p className="mt-3 text-gray-200">
          ...
          {/* Paso 3 */}
          <div className="p-8 bg-[#102544] rounded-xl border border-[#C9A86A] shadow-lg hover:shadow-xl transition">
            <CheckCircle className="mx-auto text-[#C9A86A]" size={48} />
            <div className="text-5xl font-bold text-[#C9A86A] mt-4">3</div>
            <h3 className="mt-4 text-2xl font-semibold text-[#C9A86A]">
              Decisión
            </h3>
            <p className="mt-3 text-gray-200">
